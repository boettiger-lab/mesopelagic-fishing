...
test <- adjust.fishing(scene0, "ForcedFRate", "mesopelagics", 2001:2020, value=0.50)
Fishing.rate <- rsim.run(test, method = 'AB', years= 2001:2020) 
rsim.plot(Fishing.rate, all_species)
rsim.plot(run1, all_species)

test2 <- adjust.forcing(scene0, "ForcedBio", "mesopelagics", 2001:2050, value=(0.75*9.933774834))
biomass_adj <- rsim.run(test2, method = 'AB', years= 2001:2050) 
rsim.plot(biomass_adj, all_species)
rsim.plot(run2, all_species)

test3 <- adjust.forcing(scene0, "ForcedBio", "mesopelagics", 2001:2050, value=(0.50*9.933774834))
biomass_adj3 <- rsim.run(test3, method = 'AB', years= 2001:2050) 
rsim.plot(biomass_adj3, all_species)
rsim.plot(run1, all_species)
