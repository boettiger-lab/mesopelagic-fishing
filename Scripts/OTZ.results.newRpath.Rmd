...
xlab("Proportion of original biomass") + ylab("Predators with high diet proportion ") + labs(title= "A") + theme_bw() + theme(panel.border = element_blank()) +
...
xlab("Proportion of original biomass") + ylab("Predators with low diet proportion") + labs(title= "B") + theme_bw() + theme(panel.border = element_blank()) +
theme(axis.line = element_line(colour = "black")) +
theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
theme(legend.position= "none") + theme(legend.title= element_text(size = 12), legend.text = element_text(size= 10), axis.text=element_text(size=10), axis.title=element_text(size=12)) + 
