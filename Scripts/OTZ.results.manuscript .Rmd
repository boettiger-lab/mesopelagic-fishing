...
ggsave(width = 6, height = 5, "~/Documents/OTZ.manuscript/Images/dietover.50.jpeg")
change_1_1_plot 
...
scale_color_manual(values = c("#0000FF", "#00FF70")) +
 ...
 xlim(0.70, 1.30) + geom_vline(xintercept=1, linetype= "solid", color= "black", size= 0.75) + 
xlab("Relative biomass") + ylab("Species with low diet proportion") + 
labs(col = "End biomass", title= "B") + standard_theme 
#+ ggsave(width = 6, height = 5, "~/Documents/OTZ.manuscript/Images/dietunder.50.jpeg")
change_1_2_plot
...
xlim(0.70, 1.30) + geom_vline(xintercept=1, linetype= "solid", color= "black", size= 0.75) + 
xlab("Relative biomass") + ylab("Species with no diet proportion") + 
scale_y_discrete(labels= c("Adult N. Ele. Seal"= "Adult n. elephant seal", "amphipods"= "Amphipods", "benthic shp"= "Benthic shrimp", "Brown Pelican"= "Brown pelican", "Cali. gull"= "California gull", "carniv-zoops" = "Carnivorous zooplankton", "copepods"= "Copepods", "Dungeness"= "Dungeness crab", "epibenthic"= "Epibenthic", "euphausiids"= "Euphausiids", "infauna"= "Infauna", "Juv. round."= "Juv. roundfish", "Juv. thorny."= "Juv. thornyhead", "large jellies"= "Large jellies", "micro-zoop"= "Microzooplankton", "Nearshore rock."= "Nearshore rockfish", "Pacific Mackerel"= "Pacific mackerel", "pandalid shp"= "Pandalid shrimp", "phytoplankton"= "Phytoplankton", "Pigeon Guillemot"= "Pigeon guillemot", "Rhino. auk"= "Rhinoceros auklet", "small jellies"= "Small jellies", "surf perch"= "Surf perch", "tanner crb"= "Tanner crab", "Transient Orcas"= "Transient orcas", "Yelloweye rock."= "Yelloweye rockfish")) + labs(col = "End biomass", title= "C") + standard_theme + ggsave(width = 6, height = 8, "~/Documents/OTZ.manuscript/Images/no.diet.25.jpeg")
change_2_3_plot
```
