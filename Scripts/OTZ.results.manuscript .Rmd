...
#TO NOTE: Mesopelagics currently are cut out of all of the graphs- need to make sure you have same scale for everything, can include them if want to but don't have to- can just state they were depleted to a certain level
```{r}
#Scenario 1
...
scale_color_manual(values = c("#FF0000","#0000FF", "#00FF70", "#FF00FF")) + 
 scale_y_discrete(labels= c("Tufted Puffin"= "Tufted puffin", "P. Ocean Perch"= "P. ocean perch", "Leach's S. Petrel"= "Leach's s. petrel", "Longspine thorny."= "Longspine thornyhead", "Shelf rock."= "Shelf rockfish", "Slope rock."= "Slope rockfish", "Yellowtail rock."= "Yellowtail rockfish")) + 
  ...
  xlim(0.70, 1.35) + 
xlab("Relative biomass") + ylab("Species with high diet proportion ") + labs(col = "End biomass", title= "A") + standard_theme + theme(axis.text.y=element_blank()) + theme(legend.position = "none") +
...
labs(col = "End biomass", title= "B") + standard_theme + theme(legend.position = "none") + ggsave(width = 8, height = 7, "~/Documents/OTZ.manuscript/Images/Sub.2/dietunder.50.jpeg")
change_1_2_plot
...
scale_color_manual(values = c("#FF0000","#0000FF", "#00FF70", "#FF00FF")) + 
 scale_y_discrete(labels= c("Tufted Puffin"= "Tufted puffin", "P. Ocean Perch"= "P. ocean perch", "Leach's S. Petrel"= "Leach's s. petrel", "Longspine thorny."= "Longspine thornyhead", "Shelf rock."= "Shelf rockfish", "Slope rock."= "Slope rockfish", "Yellowtail rock."= "Yellowtail rockfish")) + 
  geom_vline(xintercept=1, linetype= "solid", color= "black", size= 0.75) +
  xlim(0.70, 1.35) + 
xlab("Relative biomass") + ylab("Species with high diet proportion ") + labs(col = "End biomass", title= "D") + standard_theme + 
...
xlab("Relative biomass") + ylab("Species with low diet proportion") + 
labs(col = "End biomass", title= "E") + standard_theme + ggsave(width = 8, height = 7, "~/Documents/OTZ.manuscript/Images/Sub.2/dietunder.25.jpeg")
change_2_2_plot
...
xlim(0.70, 1.35) + geom_vline(xintercept=1, linetype= "solid", color= "black", size= 0.75) + 
xlab("Relative biomass") + ylab("Species with no diet proportion") + 
scale_y_discrete(labels= c("Adult N. Ele. Seal"= "Adult n. elephant seal", "amphipods"= "Amphipods", "benthic shp"= "Benthic shrimp", "Brown Pelican"= "Brown pelican", "Cali. gull"= "California gull", "carniv-zoops" = "Carnivorous zooplankton", "copepods"= "Copepods", "Dungeness"= "Dungeness crab", "epibenthic"= "Epibenthic", "euphausiids"= "Euphausiids", "infauna"= "Infauna", "Juv. round."= "Juv. roundfish", "Juv. thorny."= "Juv. thornyhead", "large jellies"= "Large jellies", "micro-zoop"= "Microzooplankton", "Nearshore rock."= "Nearshore rockfish", "Pacific Mackerel"= "Pacific mackerel", "pandalid shp"= "Pandalid shrimp", "phytoplankton"= "Phytoplankton", "Pigeon Guillemot"= "Pigeon guillemot", "Rhino. auk"= "Rhinoceros auklet", "small jellies"= "Small jellies", "surf perch"= "Surf perch", "tanner crb"= "Tanner crab", "Transient Orcas"= "Transient orcas", "Yelloweye rock."= "Yelloweye rockfish")) + labs(col = "End biomass", title= "F") + standard_theme + ggsave(width = 8, height = 7, "~/Documents/OTZ.manuscript/Images/Sub.2/nodiet.25.jpeg")
change_2_3_plot
```
