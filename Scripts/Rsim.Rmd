...
source("../R/ecopath.R")
source("../R/ecopath_plot.R")
source("../R/ecosim_multistep.R")
source("../R/ecosim_plot.R")
source("../R/ecosim.R")
source("../R/Extract.R")
source("../R/old_stanza_code.R")
source("../R/param.R")
source("../R/RcppExports.R")
source("../R/Rpath_methods.R")
source("../R/write_functions.R")
library(tidyverse)
library(data.table)
```
...
REco.sim <- adjust.fishing(REco.sim, 'EFFORT', group = 'Trawlers', sim.year = 25:100, 
                           value = 2) 
#In the new version of Rpath (uploaded to NOAA github, it is 'ForcedEffort' instead of just effort)
```
...
```{r rsim.run}
REco.run1 <- rsim.run(REco.sim, method = 'AB', years = 1:100) 

#Also in new Rpath the method used is 'RK4' instead of 'AB', only applying this to rsim.run after adjusting fishing effort though (wouldn't be for a base scenario situation)
#When ran the base scenario with RK4 the relative biomass was no longer 1 for all of the groups 
```
