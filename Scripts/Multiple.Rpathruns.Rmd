...
sum_data_6 %>% mutate("lower.quantile" = cut(quant_2.5, 
                      breaks = c(-Inf, 1, Inf),
                      labels = c("Below 1", "Above 1"),
                      right = TRUE))
...
intersect(comm_value$spp, noncomm_value$spp)
