...
noncomm_value <- sum_data_6 %>% filter(spp %in% noncommerical_predators)

noncomm_value %>% ggplot() + 
geom_linerange(noncomm_value, mapping=aes(y=spp, xmin= quant_2.5, xmax= quant_97.5), width=0.2, size=1, color="blue") 
```
