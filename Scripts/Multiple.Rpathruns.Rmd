...
entire_data_6 <- transform(entire_data_6,ID=as.numeric(factor(spp)))


#Statistics
sum_data_6 <- entire_data_6 %>% group_by(spp) %>% summarise(mean_biomass = mean(biomass), sd_biomass= sd(biomass))
