...
#Statistics
sum_data_6 <- entire_data_6 %>% group_by(spp, ID) %>% summarise(mean_biomass = mean(biomass), sd_biomass= sd(biomass)) %>% left_join(df1, by = "ID")
sum_data_6 <- sum_data_6 %>% left_join(df_quant1, by = "ID")
