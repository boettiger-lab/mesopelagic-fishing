...
#Graphs
```{r}
sum_data_6 <- read.csv("/Users/sallydowd/Documents/GitHub/mesopelagic-fishing/Data/sum_data_6.csv")
...
comm_value_500 <- comm_value %>% ggplot(aes(fill = median.value)) + 
  geom_pointrange(aes(y=spp, x=median_biomass, xmin=quant_2.5, xmax= quant_97.5), size=0.5, shape=22) + scale_fill_grey() + 
...
theme(axis.line = element_line(colour = "black")) + standard_theme
noncomm_value_500
```
...
annotate_figure(high_diet_plot, bottom= text_grob("Relative end biomass", size=14), left= text_grob("Species with high diet proportion", size=14, rot=90)) + 
ggsave(width = 8.75, height = 5.25, "~/Documents/OTZ.Manuscript/Images/Sub.2/high.diet.combo.jpeg", dpi=600)
...
annotate_figure(low_diet_plot, bottom= text_grob("Relative end biomass", size=14), left= text_grob("Species with low diet proportion", size=14, rot=90)) + 
ggsave(width = 8.75, height = 5.25, "~/Documents/OTZ.Manuscript/Images/Sub.2/low.diet.combo.jpeg", dpi=600)

no_diet_plot <- ggarrange(change_2_3_plot + rremove("xlab") + rremove("ylab"), change_1_3_plot + rremove("xlab") + rremove("ylab"), sum_2_3_graph + rremove("xlab") + rremove("ylab"), ncol = 3, nrow = 1, labels= c("a", "b", "c"))

annotate_figure(no_diet_plot, bottom= text_grob("Relative end biomass", size=14), left= text_grob("Species with no diet proportion", size=14, rot=90)) + 
ggsave(width = 8.75, height = 5.25, "~/Documents/OTZ.Manuscript/Images/Sub.2/no.diet.combo.jpeg", dpi=600)
```
