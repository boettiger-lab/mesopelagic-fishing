...
#Import data on price from 2007-2016 for commercially valuable predators 
```{r}
at_sea_price <- read_excel("~/Documents/WHOI/Excel/at.sea.price.xlsx")
```
...
X37_WTP_values <- read_excel("~/Documents/WHOI/Excel/37.WTP.values.xlsx")
